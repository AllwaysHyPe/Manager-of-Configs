# Stage 02 replaces the handwritten storage account with an Azure Verified
# Module. The infrastructure outcome is identical to stage 01. What changes
# is how much you have to know to get there — the AVM encodes proven defaults
# so you only specify what you actually want to change.
